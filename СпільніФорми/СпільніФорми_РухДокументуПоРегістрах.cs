                    ...
                    case "ТовариНаСкладах":
                        {
                            ...
                            await ТабличніСписки.ТовариНаСкладах_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "ПартіїТоварів":
                        {
                            ...
                            await ТабличніСписки.ПартіїТоварів_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "ЗамовленняКлієнтів":
                        {
                            ...
                            await ТабличніСписки.ЗамовленняКлієнтів_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "РозрахункиЗКлієнтами":
                        {
                            ...
                            await ТабличніСписки.РозрахункиЗКлієнтами_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "ВільніЗалишки":
                        {
                            ...
                            await ТабличніСписки.ВільніЗалишки_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "ЗамовленняПостачальникам":
                        {
                            ...
                            await ТабличніСписки.ЗамовленняПостачальникам_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "РозрахункиЗПостачальниками":
                        {
                            ...
                            await ТабличніСписки.РозрахункиЗПостачальниками_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "РухКоштів":
                        {
                            ...
                            await ТабличніСписки.РухКоштів_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "РухКоштівККМ":
                        {
                            ...
                            await ТабличніСписки.РухКоштівККМ_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "Закупівлі":
                        {
                            ...
                            await ТабличніСписки.Закупівлі_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "Продажі":
                        {
                            ...
                            await ТабличніСписки.Продажі_Записи.LoadRecords(treeView, null, false);
                    ...
                    case "ТовариВКомірках":
                        {
                            ...
                            await ТабличніСписки.ТовариВКомірках_Записи.LoadRecords(treeView, null, false);
