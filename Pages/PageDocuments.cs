...
namespace StorageAndTrade
{
    class PageDocuments : VBox
    {
        public PageDocuments() : base()
        {
            ...
            AddLink(vRight, "Розміщення товарів на складі по комірках", РозміщенняТоварівНаСкладі);
            AddLink(vRight, "Збірка товарів на складі по комірках", ЗбіркаТоварівНаСкладі);
            AddLink(vRight, "Переміщення товарів між комірками на складі", ПереміщенняТоварівНаСкладі);
