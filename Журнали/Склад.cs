...
namespace StorageAndTrade
{
    class Журнал_Склад : VBox
    {
        ...
        public Журнал_Склад() : base()
        {
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Журнали_Склад.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.Журнали_Склад.LoadRecords();
        ...
        {
            ТабличніСписки.Журнали_Склад.ДодатиВідбірПоПеріоду(
                Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
            LoadRecords();
        }
        ...
        {
            ФункціїДляЖурналів.ВідкритиСписокДокументів((ToolButton)sender!, ТабличніСписки.Журнали_Склад.AllowDocument(),
               Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
        }
