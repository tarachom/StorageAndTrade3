...
namespace StorageAndTrade
{
    class Журнал_Каса : Журнал
    {
        ...
        {
            ФункціїДляЖурналів.ВідкритиСписокДокументів(relative_to, ТабличніСписки.Журнали_Каса.AllowDocument(), ComboBoxPeriodWhere.ActiveId);
        }
        ...
        {
            ТабличніСписки.Журнали_Каса.ДодатиВідбірПоПеріоду(TreeViewGrid, ComboBoxPeriodWhere.ActiveId);
            LoadRecords();
