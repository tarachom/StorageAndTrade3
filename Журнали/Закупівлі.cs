...
namespace StorageAndTrade
{
    class Журнал_Закупівлі : Журнал
    {
        ...
        {
            ФункціїДляЖурналів.ВідкритиСписокДокументів(relative_to, ТабличніСписки.Журнали_Закупівлі.AllowDocument(), ComboBoxPeriodWhere.ActiveId);
        }
        ...
        {
            ТабличніСписки.Журнали_Закупівлі.ДодатиВідбірПоПеріоду(TreeViewGrid, ComboBoxPeriodWhere.ActiveId);
            LoadRecords();
