...
namespace StorageAndTrade
{
    class Журнал_Закупівлі : VBox
    {
        ...
        public Журнал_Закупівлі() : base()
        {
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Журнали_Закупівлі.Store);
        ...
        {
            ТабличніСписки.Журнали_Закупівлі.ДодатиВідбірПоПеріоду(
                Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
            LoadRecords();
        }
        ...
        {
            ФункціїДляЖурналів.ВідкритиСписокДокументів((ToolButton)sender!, ТабличніСписки.Журнали_Закупівлі.AllowDocument(),
               Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
        }
