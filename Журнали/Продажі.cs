...
namespace StorageAndTrade
{
    class Журнал_Продажі : VBox
    {
        ...
        public Журнал_Продажі() : base()
        {
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Журнали_Продажі.Store);
        ...
        {
            ТабличніСписки.Журнали_Продажі.ДодатиВідбірПоПеріоду(
                Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
            LoadRecords();
        }
        ...
        {
            ФункціїДляЖурналів.ВідкритиСписокДокументів((ToolButton)sender!, ТабличніСписки.Журнали_Продажі.AllowDocument(),
               Enum.Parse<Перелічення.ТипПеріодуДляЖурналівДокументів>(ComboBoxPeriodWhere.ActiveId));
        }
