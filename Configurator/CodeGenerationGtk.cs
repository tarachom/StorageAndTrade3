...
namespace StorageAndTrade_1_0.Довідники.ТабличніСписки
{
    ...
    public class Виробники_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            Виробники_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.Виробники_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.Виробники_Const.Код // [ pos = 2, type = string ]
            ...
            while (Виробники_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[Виробники_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[Виробники_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class ВидиНоменклатури_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            ВидиНоменклатури_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.ВидиНоменклатури_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.ВидиНоменклатури_Const.Код // [ pos = 2, type = string ]
            ...
            while (ВидиНоменклатури_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[ВидиНоменклатури_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[ВидиНоменклатури_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class ПакуванняОдиниціВиміру_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            ПакуванняОдиниціВиміру_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.ПакуванняОдиниціВиміру_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.ПакуванняОдиниціВиміру_Const.Код // [ pos = 2, type = string ]
            ...
            while (ПакуванняОдиниціВиміру_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[ПакуванняОдиниціВиміру_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[ПакуванняОдиниціВиміру_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class Контрагенти_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            Контрагенти_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.Контрагенти_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.Контрагенти_Const.Код // [ pos = 2, type = string ]
            ...
            while (Контрагенти_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[Контрагенти_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[Контрагенти_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class Склади_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            Склади_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.Склади_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.Склади_Const.Код // [ pos = 2, type = string ]
            ...
            while (Склади_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[Склади_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[Склади_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class ВидиЦін_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("Назва", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Код", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("Валюта", new CellRendererText(), "text", 4));
        ...
        public static void LoadRecords()
        {
            ...
            ВидиЦін_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.ВидиЦін_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.ВидиЦін_Const.Код // [ pos = 2, type = string ]
            ...
            while (ВидиЦін_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[ВидиЦін_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[ВидиЦін_Const.Код]?.ToString() ?? "", // [ pos = 2, type = string ]
    ...
    public class ВидиЦінПостачальників_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            ВидиЦінПостачальників_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.ВидиЦінПостачальників_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.ВидиЦінПостачальників_Const.Код // [ pos = 2, type = string ]
            ...
            while (ВидиЦінПостачальників_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[ВидиЦінПостачальників_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[ВидиЦінПостачальників_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class Користувачі_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            Користувачі_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.Користувачі_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.Користувачі_Const.Код // [ pos = 2, type = string ]
            ...
            while (Користувачі_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[Користувачі_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[Користувачі_Const.Код]?.ToString() ?? "" // [ pos = 2, type = string ]
    ...
    public class Файли_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("ID", new CellRendererText(), "text", 1) { Visible = false });
            /* */
            treeView.AppendColumn(new TreeViewColumn("Код", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Назва", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("НазваФайлу", new CellRendererText(), "text", 4));
            treeView.AppendColumn(new TreeViewColumn("Розмір", new CellRendererText(), "text", 5));
            treeView.AppendColumn(new TreeViewColumn("ДатаСтворення", new CellRendererText(), "text", 6));
        ...
        public static void LoadRecords()
        {
            ...
            Файли_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    ...
                    , Довідники.Файли_Const.НазваФайлу // [ pos = 3, type = string ]
                    , Довідники.Файли_Const.Розмір // [ pos = 4, type = string ]
                    , Довідники.Файли_Const.ДатаСтворення // [ pos = 5, type = datetime ]
            ...
            while (Файли_Select.MoveNext())
            {
                ...
                if (cur != null)
                    Store.AppendValues(new Файли_Записи
                    {
                        ...
                        НазваФайлу = cur.Fields?[Файли_Const.НазваФайлу]?.ToString() ?? "", // [ pos = 3, type = string ]
                        Розмір = cur.Fields?[Файли_Const.Розмір]?.ToString() ?? "", // [ pos = 4, type = string ]
                        ДатаСтворення = cur.Fields?[Файли_Const.ДатаСтворення]?.ToString() ?? "" // [ pos = 5, type = datetime ]
    ...
    public class ХарактеристикиНоменклатури_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("Назва", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Код", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("Номенклатура", new CellRendererText(), "text", 4));
    ...
    public class Каси_Записи
    {
        ...
        public static void LoadRecords()
        {
            ...
            Каси_Select.QuerySelect.Field.AddRange(
                new string[]
                {
                    Довідники.Каси_Const.Назва // [ pos = 1, type = string ]
                    , Довідники.Каси_Const.Код // [ pos = 2, type = string ]
            ...
            while (Каси_Select.MoveNext())
            {
                ...
                if (cur != null)
                    ...
                    {
                        ID = cur.UnigueID.ToString(),
                        Назва = cur.Fields?[Каси_Const.Назва]?.ToString() ?? "", // [ pos = 1, type = string ]
                        Код = cur.Fields?[Каси_Const.Код]?.ToString() ?? "", // [ pos = 2, type = string ]
                        Валюта = cur.Fields?["join_3"]?.ToString() ?? "" // [ pos = 3, type = pointer ]
    ...
    public class БанківськіРахункиОрганізацій_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("Код", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("Валюта", new CellRendererText(), "text", 4));
            treeView.AppendColumn(new TreeViewColumn("Організація", new CellRendererText(), "text", 5));
    ...
    public class ДоговориКонтрагентів_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("Назва", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Код", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("Контрагент", new CellRendererText(), "text", 4));
            treeView.AppendColumn(new TreeViewColumn("ТипДоговору", new CellRendererText(), "text", 5));
    ...
    public class СеріїНоменклатури_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            treeView.AppendColumn(new TreeViewColumn("ID", new CellRendererText(), "text", 1) { Visible = false });
            /* */
            treeView.AppendColumn(new TreeViewColumn("Номер", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Коментар", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("ДатаСтворення", new CellRendererText(), "text", 4));
    ...
    public class ПартіяТоварівКомпозит_Записи
    {
        ...
        public static void AddColumns(TreeView treeView)
        {
            ...
            /* */
            treeView.AppendColumn(new TreeViewColumn("Назва", new CellRendererText(), "text", 2));
            treeView.AppendColumn(new TreeViewColumn("Дата", new CellRendererText(), "text", 3));
            treeView.AppendColumn(new TreeViewColumn("ТипДокументу", new CellRendererText(), "text", 4));
            treeView.AppendColumn(new TreeViewColumn("ПоступленняТоварівТаПослуг", new CellRendererText(), "text", 5));
            treeView.AppendColumn(new TreeViewColumn("ВведенняЗалишків", new CellRendererText(), "text", 6));
