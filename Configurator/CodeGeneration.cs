...
namespace StorageAndTrade_1_0.РегістриНакопичення
{
    ...
    {
        public ТовариНаСкладах_ЗалишкиТаОбороти_TablePart() : base(Config.Kernel!, "tab_b33",
        ...
        public const string ВНаявностіПочатковийЗалишок = "col_a6";
        public const string ВНаявностіПрихід = "col_a7";
        public const string ВНаявностіРозхід = "col_a8";
        public const string ВНаявностіКінцевийЗалишок = "col_a9";
        public const string ДоВідвантаженняПочатковийЗалишок = "col_b1";
        public const string ДоВідвантаженняПрихід = "col_b2";
        public const string ДоВідвантаженняРозхід = "col_b3";
        public const string ДоВідвантаженняКінцевийЗалишок = "col_b4";
        public List<Record> Records { get; set; }
        ...
        public void Read()
        {
            ...
            foreach (Dictionary<string, object> fieldValue in base.FieldValueList) 
            {
                ...
                record.ВНаявностіПочатковийЗалишок = (fieldValue["col_a6"] != DBNull.Value) ? (decimal)fieldValue["col_a6"] : 0;
                ...
                record.ВНаявностіКінцевийЗалишок = (fieldValue["col_a9"] != DBNull.Value) ? (decimal)fieldValue["col_a9"] : 0;
                record.ДоВідвантаженняПочатковийЗалишок = (fieldValue["col_b1"] != DBNull.Value) ? (decimal)fieldValue["col_b1"] : 0;
                record.ДоВідвантаженняПрихід = (fieldValue["col_b2"] != DBNull.Value) ? (decimal)fieldValue["col_b2"] : 0;
                record.ДоВідвантаженняРозхід = (fieldValue["col_b3"] != DBNull.Value) ? (decimal)fieldValue["col_b3"] : 0;
                record.ДоВідвантаженняКінцевийЗалишок = (fieldValue["col_b4"] != DBNull.Value) ? (decimal)fieldValue["col_b4"] : 0;
        ...
        public void Save(bool clear_all_before_save /*= true*/) 
        {
            ...
            foreach (Record record in Records)
            {
                ...
                fieldValue.Add("col_a6", record.ВНаявностіПочатковийЗалишок);
                fieldValue.Add("col_a7", record.ВНаявностіПрихід);
                fieldValue.Add("col_a8", record.ВНаявностіРозхід);
                fieldValue.Add("col_a9", record.ВНаявностіКінцевийЗалишок);
                fieldValue.Add("col_b1", record.ДоВідвантаженняПочатковийЗалишок);
                fieldValue.Add("col_b2", record.ДоВідвантаженняПрихід);
                fieldValue.Add("col_b3", record.ДоВідвантаженняРозхід);
                fieldValue.Add("col_b4", record.ДоВідвантаженняКінцевийЗалишок);
        ...
        public class Record : RegisterAccumulationTablePartRecord
        {
            public Record()
            {
                ...
                Склад = new Довідники.Склади_Pointer();
                Серія = new Довідники.СеріїНоменклатури_Pointer();
                ВНаявностіПочатковийЗалишок = 0;
                ВНаявностіПрихід = 0;
                ВНаявностіРозхід = 0;
                ВНаявностіКінцевийЗалишок = 0;
                ДоВідвантаженняПочатковийЗалишок = 0;
                ДоВідвантаженняПрихід = 0;
                ДоВідвантаженняРозхід = 0;
                ДоВідвантаженняКінцевийЗалишок = 0;
            ...
            public Довідники.Склади_Pointer Склад { get; set; }
            public Довідники.СеріїНоменклатури_Pointer Серія { get; set; }
            public decimal ВНаявностіПочатковийЗалишок { get; set; }
            public decimal ВНаявностіПрихід { get; set; }
            public decimal ВНаявностіРозхід { get; set; }
            public decimal ВНаявностіКінцевийЗалишок { get; set; }
            public decimal ДоВідвантаженняПочатковийЗалишок { get; set; }
            public decimal ДоВідвантаженняПрихід { get; set; }
            public decimal ДоВідвантаженняРозхід { get; set; }
            public decimal ДоВідвантаженняКінцевийЗалишок { get; set; }
    ...
    public class ТовариНаСкладах_Обороти_TablePart : RegisterAccumulationTablePart
    {
        ...
        public const string ДоВідвантаженняПрихід = "col_a7";
        public const string ДоВідвантаженняРозхід = "col_a8";
        public List<Record> Records { get; set; }
        ...
        public void Read()
        {
            ...
            foreach (Dictionary<string, object> fieldValue in base.FieldValueList) 
            {
                ...
                record.ДоВідвантаженняПрихід = (fieldValue["col_a7"] != DBNull.Value) ? (decimal)fieldValue["col_a7"] : 0;
                record.ДоВідвантаженняРозхід = (fieldValue["col_a8"] != DBNull.Value) ? (decimal)fieldValue["col_a8"] : 0;
        ...
        public void Save(bool clear_all_before_save /*= true*/) 
        {
            ...
            foreach (Record record in Records)
            {
                ...
                fieldValue.Add("col_a7", record.ДоВідвантаженняПрихід);
                fieldValue.Add("col_a8", record.ДоВідвантаженняРозхід);
    ...
    {
        public РухТоварів_Обороти_TablePart() : base(Config.Kernel!, "tab_b34",
              new string[] { "col_a1", "col_a2", "col_a3", "col_a4", "col_a5" }) 
        {
            Records = new List<Record>();
        }
        ...
        public const string ХарактеристикаНоменклатури = "col_a2";
        public const string Склад = "col_a3";
        public const string КількістьПрихід = "col_a4";
        public const string КількістьРозхід = "col_a5";
        public List<Record> Records { get; set; }
        ...
        public void Read()
        {
            ...
            foreach (Dictionary<string, object> fieldValue in base.FieldValueList) 
            {
                ...
                record.ХарактеристикаНоменклатури = new Довідники.ХарактеристикиНоменклатури_Pointer(fieldValue["col_a2"]);
                record.Склад = new Довідники.Склади_Pointer(fieldValue["col_a3"]);
                record.КількістьПрихід = (fieldValue["col_a4"] != DBNull.Value) ? (decimal)fieldValue["col_a4"] : 0;
                record.КількістьРозхід = (fieldValue["col_a5"] != DBNull.Value) ? (decimal)fieldValue["col_a5"] : 0;
        ...
        public void Save(bool clear_all_before_save /*= true*/) 
        {
            ...
            foreach (Record record in Records)
            {
                ...
                fieldValue.Add("col_a2", record.ХарактеристикаНоменклатури.UnigueID.UGuid);
                fieldValue.Add("col_a3", record.Склад.UnigueID.UGuid);
                fieldValue.Add("col_a4", record.КількістьПрихід);
                fieldValue.Add("col_a5", record.КількістьРозхід);
    ...
    {
        public ВільніЗалишки_Залишки_TablePart() : base(Config.Kernel!, "tab_b24",
              new string[] { "col_a1", "col_a2", "col_a3", "col_a4", "col_a5", "col_a6", "col_a7" }) 
        {
            Records = new List<Record>();
        }
    ...
    public class ВільніЗалишки_Обороти_TablePart : RegisterAccumulationTablePart
    {
        ...
        public const string ХарактеристикаНоменклатури = "col_a2";
        public const string Склад = "col_a3";
        public const string ВНаявностіПрихід = "col_a4";
        public const string ВНаявностіРозхід = "col_a5";
        public const string ВРезервіЗіСкладуПрихід = "col_a6";
        public const string ВРезервіЗіСкладуРозхід = "col_a7";
        public const string ВРезервіПідЗамовленняПрихід = "col_a8";
        public const string ВРезервіПідЗамовленняРозхід = "col_a9";
        public List<Record> Records { get; set; }
        ...
        public void Read()
        {
            ...
            foreach (Dictionary<string, object> fieldValue in base.FieldValueList) 
            {
                ...
                record.ХарактеристикаНоменклатури = new Довідники.ХарактеристикиНоменклатури_Pointer(fieldValue["col_a2"]);
                record.Склад = new Довідники.Склади_Pointer(fieldValue["col_a3"]);
                record.ВНаявностіПрихід = (fieldValue["col_a4"] != DBNull.Value) ? (decimal)fieldValue["col_a4"] : 0;
                record.ВНаявностіРозхід = (fieldValue["col_a5"] != DBNull.Value) ? (decimal)fieldValue["col_a5"] : 0;
                record.ВРезервіЗіСкладуПрихід = (fieldValue["col_a6"] != DBNull.Value) ? (decimal)fieldValue["col_a6"] : 0;
                record.ВРезервіЗіСкладуРозхід = (fieldValue["col_a7"] != DBNull.Value) ? (decimal)fieldValue["col_a7"] : 0;
                record.ВРезервіПідЗамовленняПрихід = (fieldValue["col_a8"] != DBNull.Value) ? (decimal)fieldValue["col_a8"] : 0;
                record.ВРезервіПідЗамовленняРозхід = (fieldValue["col_a9"] != DBNull.Value) ? (decimal)fieldValue["col_a9"] : 0;
        ...
        public void Save(bool clear_all_before_save /*= true*/) 
        {
            ...
            foreach (Record record in Records)
            {
                ...
                fieldValue.Add("col_a2", record.ХарактеристикаНоменклатури.UnigueID.UGuid);
                fieldValue.Add("col_a3", record.Склад.UnigueID.UGuid);
                fieldValue.Add("col_a4", record.ВНаявностіПрихід);
                fieldValue.Add("col_a5", record.ВНаявностіРозхід);
                fieldValue.Add("col_a6", record.ВРезервіЗіСкладуПрихід);
                fieldValue.Add("col_a7", record.ВРезервіЗіСкладуРозхід);
                fieldValue.Add("col_a8", record.ВРезервіПідЗамовленняПрихід);
                fieldValue.Add("col_a9", record.ВРезервіПідЗамовленняРозхід);
    ...
    public class ВільніЗалишки_ЗалишкиТаОбороти_TablePart : RegisterAccumulationTablePart
    {
        public ВільніЗалишки_ЗалишкиТаОбороти_TablePart() : base(Config.Kernel!, "tab_b30",
              new string[] { "col_a1", "col_a2", "col_a3", "col_a4", "col_a5", "col_a6", "col_a7", "col_a8", "col_a9", "col_b1", "col_b2", "col_b3", "col_b4", "col_b5", "col_b6", "col_b7" }) 
        {
            Records = new List<Record>();
        }
        ...
        public const string ХарактеристикаНоменклатури = "col_a3";
        public const string Склад = "col_a4";
        public const string ВНаявностіПочатковийЗалишок = "col_a5";
        public const string ВНаявностіПрихід = "col_a6";
        public const string ВНаявностіРозхід = "col_a7";
        public const string ВНаявностіКінцевийЗалишок = "col_a8";
        public const string ВРезервіЗіСкладуПочатковийЗалишок = "col_a9";
        public const string ВРезервіЗіСкладуПрихід = "col_b1";
        public const string ВРезервіЗіСкладуРозхід = "col_b2";
        public const string ВРезервіЗіСкладуКінцевийЗалишок = "col_b3";
        public const string ВРезервіПідЗамовленняПочатковийЗалишок = "col_b4";
        public const string ВРезервіПідЗамовленняПрихід = "col_b5";
        public const string ВРезервіПідЗамовленняРозхід = "col_b6";
        public const string ВРезервіПідЗамовленняКінцевийЗалишок = "col_b7";
        public List<Record> Records { get; set; }
        ...
        public void Read()
        {
            ...
            foreach (Dictionary<string, object> fieldValue in base.FieldValueList) 
            {
                ...
                record.ХарактеристикаНоменклатури = new Довідники.ХарактеристикиНоменклатури_Pointer(fieldValue["col_a3"]);
                record.Склад = new Довідники.Склади_Pointer(fieldValue["col_a4"]);
                record.ВНаявностіПочатковийЗалишок = (fieldValue["col_a5"] != DBNull.Value) ? (decimal)fieldValue["col_a5"] : 0;
                ...
                record.ВНаявностіКінцевийЗалишок = (fieldValue["col_a8"] != DBNull.Value) ? (decimal)fieldValue["col_a8"] : 0;
                record.ВРезервіЗіСкладуПочатковийЗалишок = (fieldValue["col_a9"] != DBNull.Value) ? (decimal)fieldValue["col_a9"] : 0;
                record.ВРезервіЗіСкладуПрихід = (fieldValue["col_b1"] != DBNull.Value) ? (decimal)fieldValue["col_b1"] : 0;
                record.ВРезервіЗіСкладуРозхід = (fieldValue["col_b2"] != DBNull.Value) ? (decimal)fieldValue["col_b2"] : 0;
                record.ВРезервіЗіСкладуКінцевийЗалишок = (fieldValue["col_b3"] != DBNull.Value) ? (decimal)fieldValue["col_b3"] : 0;
                record.ВРезервіПідЗамовленняПочатковийЗалишок = (fieldValue["col_b4"] != DBNull.Value) ? (decimal)fieldValue["col_b4"] : 0;
                record.ВРезервіПідЗамовленняПрихід = (fieldValue["col_b5"] != DBNull.Value) ? (decimal)fieldValue["col_b5"] : 0;
                record.ВРезервіПідЗамовленняРозхід = (fieldValue["col_b6"] != DBNull.Value) ? (decimal)fieldValue["col_b6"] : 0;
                record.ВРезервіПідЗамовленняКінцевийЗалишок = (fieldValue["col_b7"] != DBNull.Value) ? (decimal)fieldValue["col_b7"] : 0;
        ...
        public void Save(bool clear_all_before_save /*= true*/) 
        {
            ...
            foreach (Record record in Records)
            {
                ...
                fieldValue.Add("col_a3", record.ХарактеристикаНоменклатури.UnigueID.UGuid);
                fieldValue.Add("col_a4", record.Склад.UnigueID.UGuid);
                fieldValue.Add("col_a5", record.ВНаявностіПочатковийЗалишок);
                fieldValue.Add("col_a6", record.ВНаявностіПрихід);
                fieldValue.Add("col_a7", record.ВНаявностіРозхід);
                fieldValue.Add("col_a8", record.ВНаявностіКінцевийЗалишок);
                fieldValue.Add("col_a9", record.ВРезервіЗіСкладуПочатковийЗалишок);
                fieldValue.Add("col_b1", record.ВРезервіЗіСкладуПрихід);
                fieldValue.Add("col_b2", record.ВРезервіЗіСкладуРозхід);
                fieldValue.Add("col_b3", record.ВРезервіЗіСкладуКінцевийЗалишок);
                fieldValue.Add("col_b4", record.ВРезервіПідЗамовленняПочатковийЗалишок);
                fieldValue.Add("col_b5", record.ВРезервіПідЗамовленняПрихід);
                fieldValue.Add("col_b6", record.ВРезервіПідЗамовленняРозхід);
                fieldValue.Add("col_b7", record.ВРезервіПідЗамовленняКінцевийЗалишок);
        ...
        public class Record : RegisterAccumulationTablePartRecord
        {
            public Record()
            {
                ...
                ВНаявностіРозхід = 0;
                ВНаявностіКінцевийЗалишок = 0;
                ВРезервіЗіСкладуПочатковийЗалишок = 0;
                ВРезервіЗіСкладуПрихід = 0;
                ВРезервіЗіСкладуРозхід = 0;
                ВРезервіЗіСкладуКінцевийЗалишок = 0;
                ВРезервіПідЗамовленняПочатковийЗалишок = 0;
                ВРезервіПідЗамовленняПрихід = 0;
                ВРезервіПідЗамовленняРозхід = 0;
                ВРезервіПідЗамовленняКінцевийЗалишок = 0;
            ...
            public decimal ВНаявностіРозхід { get; set; }
            public decimal ВНаявностіКінцевийЗалишок { get; set; }
            public decimal ВРезервіЗіСкладуПочатковийЗалишок { get; set; }
            public decimal ВРезервіЗіСкладуПрихід { get; set; }
            public decimal ВРезервіЗіСкладуРозхід { get; set; }
            public decimal ВРезервіЗіСкладуКінцевийЗалишок { get; set; }
            public decimal ВРезервіПідЗамовленняПочатковийЗалишок { get; set; }
            public decimal ВРезервіПідЗамовленняПрихід { get; set; }
            public decimal ВРезервіПідЗамовленняРозхід { get; set; }
            public decimal ВРезервіПідЗамовленняКінцевийЗалишок { get; set; }
