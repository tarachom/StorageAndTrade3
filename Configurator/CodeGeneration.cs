 ...
 * Дата конфігурації: 23.12.2022 20:25:23
 *
 */
...
{  
    ...
    {
        public РухТоварів_Обороти_TablePart() : base(Config.Kernel!, "tab_b31",
...
namespace StorageAndTrade_1_0.РегістриНакопичення.Розрахунок
{
