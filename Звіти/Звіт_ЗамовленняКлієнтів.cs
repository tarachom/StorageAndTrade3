...
";
            ...
            //PDF
            {
                ...
                Звіт.PDFColumnSettings.Add("ЗамовленняКлієнта_Назва", new("Замовлення клієнта", 6));
                Звіт.PDFColumnSettings.Add("Номенклатура_Назва", new("Номенклатура", 5));
            ...
            //Excel
            {
                ...
                Звіт.ExcelColumnSettings.Add("ЗамовленняКлієнта_Назва", new("Замовлення клієнта"));
                Звіт.ExcelColumnSettings.Add("Номенклатура_Назва", new("Номенклатура"));
