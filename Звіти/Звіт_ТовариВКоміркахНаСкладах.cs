...
";
            ...
            ТипиДаних.Add("Пакування_Назва", ПакуванняОдиниціВиміру_Const.POINTER);
            ТипиДаних.Add("Серія_Номер", СеріїНоменклатури_Const.POINTER);
            ТипиДаних.Add("Приміщення_Назва", СкладськіПриміщення_Const.POINTER);
            ТипиДаних.Add("Склад_Назва", Склади_Const.POINTER);
            ТипиДаних.Add("Комірка_Назва", СкладськіКомірки_Const.POINTER);
