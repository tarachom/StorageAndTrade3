...
";
            ...
            Звіт.ColumnSettings.Add("ВРезервіЗіСкладу", new("В резерві зі складу", "", "", 1, ЗвітСторінка.ФункціяДляКолонкиБазоваДляЧисла));
            Звіт.ColumnSettings.Add("ВРезервіПідЗамовлення", new("В резерві під замовлення", "", "", 1, ЗвітСторінка.ФункціяДляКолонкиБазоваДляЧисла));
