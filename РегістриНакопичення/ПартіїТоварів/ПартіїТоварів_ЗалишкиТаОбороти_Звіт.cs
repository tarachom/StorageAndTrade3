...
";
            ...
            Звіт.ColumnSettings.Add("Рядок", new("Рядок", "", "", 1));
            Звіт.ColumnSettings.Add("КількістьПрихід", new("Кількість прихід", "", "", 1));
            Звіт.ColumnSettings.Add("КількістьРозхід", new("Кількість розхід", "", "", 1));
            Звіт.ColumnSettings.Add("КількістьЗалишок", new("Кількість", "", "", 1));
            Звіт.ColumnSettings.Add("СобівартістьПрихід", new("Собівартість прихід", "", "", 1));
            Звіт.ColumnSettings.Add("СобівартістьРозхід", new("Собівартість розхід", "", "", 1));
            Звіт.ColumnSettings.Add("СобівартістьЗалишок", new("Собівартість", "", "", 1));
