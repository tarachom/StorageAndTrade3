...
namespace StorageAndTrade
{
    class ПоверненняТоварівПостачальнику_Елемент : ДокументЕлемент
    {
        ...
        {
            ПоверненняТоварівПостачальнику_Objest.UnigueIDChanged += UnigueIDChanged;
            ПоверненняТоварівПостачальнику_Objest.CaptionChanged += CaptionChanged;
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(ПоверненняТоварівПостачальнику_Objest.GetBasis(), Caption, ex);
            }
