...
namespace StorageAndTrade
{
    class ПереміщенняТоварів_Елемент : VBox
    {
        ...
        Склади_PointerControl СкладВідправник = new Склади_PointerControl();
        Склади_PointerControl СкладОтримувач = new Склади_PointerControl();
        ...
        public void SetValue()
        {
            if (IsNew)
            {
                ...
                ПереміщенняТоварів_Objest.СкладВідправник = ЗначенняЗаЗамовчуванням.ОснонийСклад_Const;
