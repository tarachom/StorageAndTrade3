...
namespace StorageAndTrade
{
    class РозміщенняТоварівНаСкладі_Елемент : ДокументЕлемент
    {
        ...
        {
            РозміщенняТоварівНаСкладі_Objest.UnigueIDChanged += UnigueIDChanged;
            РозміщенняТоварівНаСкладі_Objest.CaptionChanged += CaptionChanged;
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(РозміщенняТоварівНаСкладі_Objest.GetBasis(), Caption, ex);
            }
