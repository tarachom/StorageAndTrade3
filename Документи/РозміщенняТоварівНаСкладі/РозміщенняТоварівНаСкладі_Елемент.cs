...
namespace StorageAndTrade
{
    class РозміщенняТоварівНаСкладі_Елемент : VBox
    {
        ...
        void GetValue()
        {
            ...
            РозміщенняТоварівНаСкладі_Objest.Назва = $"Розміщення товарів на складі №{РозміщенняТоварівНаСкладі_Objest.НомерДок} від {РозміщенняТоварівНаСкладі_Objest.ДатаДок.ToShortDateString()}";
        ...
        void OnSaveAndSpendClick(object? sender, EventArgs args)
        {
            ...
            if (РозміщенняТоварівНаСкладі_Objest.Spend)
