...
namespace StorageAndTrade
{
    class ЗбіркаТоварівНаСкладі_Елемент : VBox
    {
        ...
        public void SetValue()
        {
            if (IsNew)
            {
                ЗбіркаТоварівНаСкладі_Objest.НомерДок = (++НумераціяДокументів.ЗбіркаТоварівНаСкладі_Const).ToString("D8");
                ...
                ЗбіркаТоварівНаСкладі_Objest.Автор = Program.Користувач;
            }
        ...
        void GetValue()
        {
            ...
            ЗбіркаТоварівНаСкладі_Objest.Назва = $"Збірка товарів на складі №{ЗбіркаТоварівНаСкладі_Objest.НомерДок} від {ЗбіркаТоварівНаСкладі_Objest.ДатаДок.ToShortDateString()}";
