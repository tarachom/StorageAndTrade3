...
namespace StorageAndTrade
{
    class ЗбіркаТоварівНаСкладі_PointerControl : PointerControl
    {
        public ЗбіркаТоварівНаСкладі_PointerControl()
        {
            ...
            Caption = "Збірка товарів на складі:";
        }
        ...
        {
            ЗбіркаТоварівНаСкладі page = new ЗбіркаТоварівНаСкладі(true);

            page.DocumentPointerItem = Pointer;
            page.CallBack_OnSelectPointer = (ЗбіркаТоварівНаСкладі_Pointer selectPointer) =>
            {
                Pointer = selectPointer;
            };

            Program.GeneralForm?.CreateNotebookPage("Вибір - Розміщення nоварів на складі:", () => { return page; }, true);
