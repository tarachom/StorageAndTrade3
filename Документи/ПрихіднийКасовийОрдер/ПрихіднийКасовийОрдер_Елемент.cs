...
namespace StorageAndTrade
{
    class ПрихіднийКасовийОрдер_Елемент : ДокументЕлемент
    {
        ...
        {
            ПрихіднийКасовийОрдер_Objest.UnigueIDChanged += UnigueIDChanged;
            ПрихіднийКасовийОрдер_Objest.CaptionChanged += CaptionChanged;
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(ПрихіднийКасовийОрдер_Objest.GetBasis(), Caption, ex);
            }
