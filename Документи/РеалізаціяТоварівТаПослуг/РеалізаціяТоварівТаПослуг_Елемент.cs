...
namespace StorageAndTrade
{
    class РеалізаціяТоварівТаПослуг_Елемент : ДокументЕлемент
    {
        ...
        {
            РеалізаціяТоварівТаПослуг_Objest.UnigueIDChanged += UnigueIDChanged;
            РеалізаціяТоварівТаПослуг_Objest.CaptionChanged += CaptionChanged;
        ...
        protected override void CreateContainer4(Box vBox)
        {
            ...
            //Курс та Кратність
            Box hBox1 = CreateField(vBox, "Курс:", Курс);
        ...
        public override async void SetValue()
        {
            if (IsNew)
            {
                await РеалізаціяТоварівТаПослуг_Objest.New();
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            try
            {
                if (await РеалізаціяТоварівТаПослуг_Objest.Save())
                {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(РеалізаціяТоварівТаПослуг_Objest.GetBasis(), Caption, ex);
            }           
