...
namespace StorageAndTrade
{
    class РеалізаціяТоварівТаПослуг_Елемент : VBox
    {
        ...
        public void SetValue()
        {
            if (IsNew)
            {
                РеалізаціяТоварівТаПослуг_Objest.НомерДок = (++НумераціяДокументів.ПоступленняТоварівТаПослуг_Const).ToString("D8");
                ...
                РеалізаціяТоварівТаПослуг_Objest.Автор = Program.Користувач;
                РеалізаціяТоварівТаПослуг_Objest.Менеджер = Program.Користувач;
