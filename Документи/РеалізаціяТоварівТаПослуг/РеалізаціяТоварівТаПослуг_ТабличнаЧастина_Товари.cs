...
";
        ...
        void AddColumn()
        {
            ...
            //ВидЦіни
            {
                TreeViewColumn ВидЦіни = new TreeViewColumn("Вид ціни", new CellRendererText(), "text", (int)Columns.ВидЦіни) { MinWidth = 100 };
            ...
            //ЗамовленняКлієнта
            {
                TreeViewColumn ЗамовленняКлієнта = new TreeViewColumn("Замовлення клієнта", new CellRendererText(), "text", (int)Columns.ЗамовленняКлієнта) { MinWidth = 300 };
            ...
            //РахунокФактура
            {
                TreeViewColumn РахунокФактура = new TreeViewColumn("Рахунок фактура", new CellRendererText(), "text", (int)Columns.РахунокФактура) { MinWidth = 300 };
            ...
            //Склад
            {
                TreeViewColumn Склад = new TreeViewColumn("Склад", new CellRendererText(), "text", (int)Columns.Склад) { MinWidth = 300 };
