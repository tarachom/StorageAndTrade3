                ...
                if (Message.Request(Program.GeneralForm, "Копіювати?") == ResponseType.Yes)
                {
                    ...
                    foreach (TreePath itemPath in selectionRows)
                    {
                        ...
                        if (ВнутрішнєСпоживанняТоварів_Objest.Read(new UnigueID(uid)))
                        {
                            ...
                            ВнутрішнєСпоживанняТоварів_Objest_Новий.Коментар = "Копія: " + ВнутрішнєСпоживанняТоварів_Objest.Назва;
        ...
        void OnExportXMLClick(object? sender, EventArgs arg)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                foreach (TreePath itemPath in selectionRows)
                {
                    ...
                    string pathToSave = System.IO.Path.Combine(AppContext.BaseDirectory, $"ВнутрішнєСпоживанняТоварів{uid}.xml");
                    ВнутрішнєСпоживанняТоварів_Export.ToXmlFile(new ВнутрішнєСпоживанняТоварів_Pointer(new UnigueID(uid)), pathToSave);
                }
