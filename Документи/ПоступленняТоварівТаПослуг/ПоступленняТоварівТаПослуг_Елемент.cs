    ...
    class ПоступленняТоварівТаПослуг_Елемент : VBox
    {
        ...
        public void SetValue()
        {
            if (IsNew)
            {
                ...
                ПоступленняТоварівТаПослуг_Objest.Автор = Program.Користувач;
                ПоступленняТоварівТаПослуг_Objest.Менеджер = Program.Користувач;
            }
        ...
        void OnSaveAndSpendClick(object? sender, EventArgs args)
        {
            ...
            if (ПоступленняТоварівТаПослуг_Objest.Spend)
