...
";
        ...
        void AddColumn()
        {
            ...
            //ЗамовленняПостачальнику
            {
                TreeViewColumn ЗамовленняПостачальнику = new TreeViewColumn("Замовлення постачальнику", new CellRendererText(), "text", (int)Columns.ЗамовленняПостачальнику) { MinWidth = 300 };
