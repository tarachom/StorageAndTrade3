...
namespace StorageAndTrade
{
    class ПереміщенняТоварівНаСкладі_ТабличнаЧастина_Товари : ДокументТабличнаЧастина
    {
        ...
        public override async ValueTask LoadRecords()
        {
            ...
            {
                ПереміщенняТоварівНаСкладі_Objest.Товари_TablePart.FillJoin([ПереміщенняТоварівНаСкладі_Товари_TablePart.НомерРядка]);
        ...
        protected override async void ButtonSelect(TreeIter iter, int rowNumber, int colNumber, Popover popoverSmallSelect)
        {
            ...
            switch ((Columns)colNumber)
            {
                ...
                case Columns.КоміркаВідправник:
                    {
                        СкладськіКомірки_ШвидкийВибір page = new СкладськіКомірки_ШвидкийВибір() { PopoverParent = popoverSmallSelect, DirectoryPointerItem = запис.КоміркаВідправник.UnigueID };
                        page.CallBack_OnSelectPointer = async (UnigueID selectPointer) =>
                        {
                ...
                case Columns.КоміркаОтримувач:
                    {
                        СкладськіКомірки_ШвидкийВибір page = new СкладськіКомірки_ШвидкийВибір() { PopoverParent = popoverSmallSelect, DirectoryPointerItem = запис.КоміркаОтримувач.UnigueID };
                        page.CallBack_OnSelectPointer = async (UnigueID selectPointer) =>
                        {
