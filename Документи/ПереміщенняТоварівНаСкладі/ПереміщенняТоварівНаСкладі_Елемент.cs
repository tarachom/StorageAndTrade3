...
namespace StorageAndTrade
{
    class ПереміщенняТоварівНаСкладі_Елемент : VBox
    {
        ...
        void GetValue()
        {
            ...
            ПереміщенняТоварівНаСкладі_Objest.Назва = $"Розміщення товарів на складі №{ПереміщенняТоварівНаСкладі_Objest.НомерДок} від {ПереміщенняТоварівНаСкладі_Objest.ДатаДок.ToShortDateString()}";
