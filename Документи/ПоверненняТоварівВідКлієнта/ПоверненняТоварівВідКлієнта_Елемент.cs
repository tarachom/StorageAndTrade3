...
namespace StorageAndTrade
{
    class ПоверненняТоварівВідКлієнта_Елемент : ДокументЕлемент
    {
        ...
        {
            ПоверненняТоварівВідКлієнта_Objest.UnigueIDChanged += UnigueIDChanged;
            ПоверненняТоварівВідКлієнта_Objest.CaptionChanged += CaptionChanged;
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(ПоверненняТоварівВідКлієнта_Objest.GetBasis(), Caption, ex);
            }
