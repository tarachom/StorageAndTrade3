...
{
    class ПоверненняТоварівВідКлієнта_ТабличнаЧастина_Товари : VBox
    {
        ...
        void AddColumn()
        {
            ...
            //РеалізаціяТоварівТаПослуг
            {
                TreeViewColumn РеалізаціяТоварівТаПослуг = new TreeViewColumn("Документ реалізації", new CellRendererText(), "text", (int)Columns.РеалізаціяТоварівТаПослуг) { MinWidth = 100 };
