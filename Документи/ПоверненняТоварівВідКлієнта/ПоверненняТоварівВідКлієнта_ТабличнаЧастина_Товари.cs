    ...
    class ПоверненняТоварівВідКлієнта_ТабличнаЧастина_Товари : ДокументТабличнаЧастина
    {
        ...
        void AddColumn()
        {
            ...
            //ДокументРеалізації
            {
                ...
                SetColIndex(column, Columns.ДокументРеалізації);
                TreeViewGrid.AppendColumn(column);
            }
        ...
        public override async ValueTask LoadRecords()
        {
            if (ЕлементВласник != null)
            {
                ...
                foreach (ПоверненняТоварівВідКлієнта_Товари_TablePart.Record record in ЕлементВласник.Товари_TablePart.Records)
                {
                ...
                case Columns.ДокументРеалізації:
                    {
                        ...
                        {
                            DocumentPointerItem = запис.ДокументРеалізації.UniqueID,
                            CallBack_OnSelectPointer = async (UniqueID selectPointer) =>
                            {
