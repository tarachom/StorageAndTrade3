...
namespace StorageAndTrade
{
    public class АктВиконанихРобіт : ДокументЖурнал
    {
        ...
        {
            return ТабличніСписки.АктВиконанихРобіт_Записи.CreateFilter(TreeViewGrid, () => PagesShow(LoadRecords_OnFilter));
        }
        ...
        protected override async ValueTask BeforeSetValue()
        {
            ...
            NotebookFunction.AddChangeFunc(Program.GeneralNotebook, Name, LoadRecords, АктВиконанихРобіт_Const.POINTER);
        }
