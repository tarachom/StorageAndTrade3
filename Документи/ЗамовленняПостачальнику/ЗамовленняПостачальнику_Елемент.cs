...
namespace StorageAndTrade
{
    class ЗамовленняПостачальнику_Елемент : VBox
    {
        ...
        void CreatePack1(HPaned hPaned)
        {
            ...
            hBoxNumberDataDoc.PackStart(new Label("Замовлення постачальнику №:"), false, false, 5);
        ...
        public void SetValue()
        {
            if (IsNew)
            {
                ...
                ЗамовленняПостачальнику_Objest.Автор = Program.Користувач;
                ЗамовленняПостачальнику_Objest.Менеджер = Program.Користувач;
            }
        ...
        void OnSaveAndSpendClick(object? sender, EventArgs args)
        {
            ...
            if (ЗамовленняПостачальнику_Objest.Spend)
