...
namespace StorageAndTrade
{
    class ЗамовленняКлієнта_Елемент : ДокументЕлемент
    {
        ...
        public override async void SetValue()
        {
            ...
            СпосібДоставки.ActiveId = ЗамовленняКлієнта_Objest.СпосібДоставки.ToString();
        ...
        protected override async ValueTask<bool> Save()
        {
            ...
            try
            {
                if (await ЗамовленняКлієнта_Objest.Save())
                {
            ...
            {
                ФункціїДляПовідомлень.ДодатиПовідомлення(ЗамовленняКлієнта_Objest.GetBasis(), Caption, ex);
            }
