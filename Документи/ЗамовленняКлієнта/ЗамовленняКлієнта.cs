...
namespace StorageAndTrade
{
    public class ЗамовленняКлієнта : ДокументЖурнал
    {
        public ЗамовленняКлієнта()
        {
            ...
            ТабличніСписки.ЗамовленняКлієнта_Записи.Сторінки(TreeViewGrid, new Сторінки.Налаштування() { PageSize = 300, Тип = Сторінки.ТипЖурналу.Документи });
        }
        ...
        {
            return ТабличніСписки.ЗамовленняКлієнта_Записи.CreateFilter(TreeViewGrid, () => PagesShow(LoadRecords_OnFilter));
        }
        ...
        protected override async ValueTask BeforeSetValue()
        {
            ...
            NotebookFunction.AddChangeFunc(Program.GeneralNotebook, Name, LoadRecords, ЗамовленняКлієнта_Const.POINTER);
        }
