...
namespace StorageAndTrade
{
    class ПсуванняТоварів_ТабличнаЧастина_Товари : ДокументТабличнаЧастина
    {
        ...
        public ПсуванняТоварів_ТабличнаЧастина_Товари()
        {
        ...
        public override async ValueTask LoadRecords()
        {
            ...
            if (ЕлементВласник != null)
            {
                ...
                foreach (ПсуванняТоварів_Товари_TablePart.Record record in ЕлементВласник.Товари_TablePart.Records)
                {
        ...
        public override async ValueTask SaveRecords()
        {
            if (ЕлементВласник != null)
            {
                ...
                foreach (Запис запис in Записи)
                {
                    ЕлементВласник.Товари_TablePart.Records.Add(new ПсуванняТоварів_Товари_TablePart.Record()
                    {
                        UID = запис.ID,
