...
{
    class ПсуванняТоварів_ТабличнаЧастина_Товари : ДокументТабличнаЧастина
    {
        public ПсуванняТоварів_Objest? ПсуванняТоварів_Objest { get; set; }
        ...
        public ПсуванняТоварів_ТабличнаЧастина_Товари() : base()
        {
        ...
        public override async ValueTask SaveRecords()
        {
            if (ПсуванняТоварів_Objest != null)
            {
                ПсуванняТоварів_Objest.Товари_TablePart.Records.Clear();

                int sequenceNumber = 0;

                foreach (Запис запис in Записи)
                {
                    ПсуванняТоварів_Товари_TablePart.Record record = new ПсуванняТоварів_Товари_TablePart.Record
                    {
                        UID = запис.ID,
                    ...
                    ПсуванняТоварів_Objest.Товари_TablePart.Records.Add(record);
                }

                await ПсуванняТоварів_Objest.Товари_TablePart.Save(true);
        ...
        void AddColumn()
        {
            ...
            //Серія
            {
                TreeViewColumn Серія = new TreeViewColumn("Серія", new CellRendererText(), "text", (int)Columns.Серія) { Resizable = true, MinWidth = 100 };
