...
namespace StorageAndTrade
{
    class Файли_ШвидкийВибір : VBox
    {
        ...
        public Файли_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Файли") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    Файли_Елемент page = new Файли_Елемент { IsNew = true, CallBack_OnSelectPointer = CallBack_OnSelectPointer };

                    Program.GeneralForm?.CreateNotebookPage($"Файли: *", () => { return page; }, true);
            ...
            //Очистка
            {
                ...
                linkClear.Clicked += (object? sender, EventArgs args) =>
                {
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new Файли_Pointer());
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Файли_ЗаписиШвидкийВибір.Store);
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new Файли_Pointer(unigueID);
            }
        }
