...
namespace StorageAndTrade
{
    class СеріїНоменклатури_ШвидкийВибір : VBox
    {
        ...
        public СеріїНоменклатури_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Серії") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new СеріїНоменклатури_Pointer(unigueID);
            }
        }
