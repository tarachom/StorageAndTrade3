...
{
    class ВидиЦінПостачальників_ШвидкийВибір : VBox
    {
        ...
        public ВидиЦінПостачальників_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Види цін постачальників") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
                linkPage.Clicked += (object? sender, EventArgs args) =>
                {
                    ...
                    Program.GeneralForm?.CreateNotebookPage("Вибір - Види цін постачальників", () => { return page; }, true);
            ...
            //Новий
            {
                ...
                {
                    ВидиЦінПостачальників_Елемент page = new ВидиЦінПостачальників_Елемент { IsNew = true, CallBack_OnSelectPointer = CallBack_OnSelectPointer };
            ...
            //Очистка
            {
                ...
                linkClear.Clicked += (object? sender, EventArgs args) =>
                {
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new ВидиЦінПостачальників_Pointer());
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ВидиЦінПостачальників_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.ВидиЦінПостачальників_ЗаписиШвидкийВибір.LoadRecords();
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new ВидиЦінПостачальників_Pointer(unigueID);
            }
        }
