...
namespace StorageAndTrade
{
    class Блокнот : VBox
    {
        public Блокнот_Pointer? SelectPointerItem { get; set; }
        ...
        public Блокнот() : base()
        {
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Блокнот_Записи.Store);
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                SelectPointerItem = new StorageAndTrade_1_0.Довідники.Блокнот_Pointer(unigueID);
            }
        }
