...
{
    class Організації_ТабличнаЧастина_Контакти : ДовідникТабличнаЧастина
    {
        ...
        public Організації_ТабличнаЧастина_Контакти()
        {
        ...
        public override async ValueTask SaveRecords()
        {
            if (ЕлементВласник != null)
            {
                ...
                {
                    ЕлементВласник.Контакти_TablePart.Records.Add(new Організації_Контакти_TablePart.Record()
                    {
                        UID = запис.ID,
                        Тип = запис.Тип,
                        Значення = запис.Значення,
