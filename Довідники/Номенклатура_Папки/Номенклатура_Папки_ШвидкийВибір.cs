...
namespace StorageAndTrade
{
    class Номенклатура_Папки_ШвидкийВибір : ДовідникШвидкийВибір
    {
        ...
        public override async ValueTask LoadRecords()
        {
            ...
            await ТабличніСписки.Номенклатура_Папки_ЗаписиШвидкийВибір.LoadRecords(TreeViewGrid, OpenFolder, SelectPointerItem, DirectoryPointerItem);
        }
        ...
        {
            await Номенклатура_Папки_Функції.OpenPageElement(IsNew, uniqueID, null, CallBack_OnSelectPointer);
        }
