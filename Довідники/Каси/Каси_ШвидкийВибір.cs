...
namespace StorageAndTrade
{
    class Каси_ШвидкийВибір : VBox
    {
        ...
        public Каси_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Каси") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    Каси_Елемент page = new Каси_Елемент { IsNew = true };
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Каси_ЗаписиШвидкийВибір.Store);
