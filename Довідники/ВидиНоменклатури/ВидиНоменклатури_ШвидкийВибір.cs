...
{
    class ВидиНоменклатури_ШвидкийВибір : VBox
    {
        public Popover? PopoverParent { get; set; }
        public ВидиНоменклатури_Pointer? DirectoryPointerItem { get; set; }
        public System.Action<ВидиНоменклатури_Pointer>? CallBack_OnSelectPointer { get; set; }

        TreeView TreeViewGrid;
        SearchControl2 ПошукПовнотекстовий = new SearchControl2();

        public ВидиНоменклатури_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Види номенклатури") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    ВидиНоменклатури_Елемент page = new ВидиНоменклатури_Елемент { IsNew = true };
            ...
            //Очистка
            {
                ...
                linkClear.Clicked += (object? sender, EventArgs args) =>
                {
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new ВидиНоменклатури_Pointer());
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ВидиНоменклатури_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.ВидиНоменклатури_ЗаписиШвидкийВибір.Where.Clear();

            ТабличніСписки.ВидиНоменклатури_ЗаписиШвидкийВибір.LoadRecords();
        ...
        void LoadRecords_OnSearch(string searchText)
        {
            ...
            //Назва
            ТабличніСписки.ВидиНоменклатури_ЗаписиШвидкийВибір.Where.Add(
        ...
        void OnButtonPressEvent(object? sender, ButtonPressEventArgs args)
        {
            if (args.Event.Type == Gdk.EventType.DoubleButtonPress && TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                if (TreeViewGrid.Model.GetIter(out iter, TreeViewGrid.Selection.GetSelectedRows()[0]))
                {
                    ...
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new ВидиНоменклатури_Pointer(new UnigueID(uid)));
