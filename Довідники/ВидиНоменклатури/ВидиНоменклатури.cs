...
{
    class ВидиНоменклатури : VBox
    {
        public ВидиНоменклатури_Pointer? SelectPointerItem { get; set; }
        ...
        public ВидиНоменклатури(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ВидиНоменклатури_Записи.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.ВидиНоменклатури_Записи.LoadRecords();
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                SelectPointerItem = new StorageAndTrade_1_0.Довідники.ВидиНоменклатури_Pointer(unigueID);
            }
        }
