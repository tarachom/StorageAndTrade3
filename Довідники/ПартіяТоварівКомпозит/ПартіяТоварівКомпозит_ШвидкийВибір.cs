...
{
    class ПартіяТоварівКомпозит_ШвидкийВибір : VBox
    {
        ...
        public ПартіяТоварівКомпозит_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            BorderWidth = 0;
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ПартіяТоварівКомпозит_ЗаписиШвидкийВибір.Store);
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new ПартіяТоварівКомпозит_Pointer(unigueID);
            }
        }
