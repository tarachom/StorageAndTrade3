...
namespace StorageAndTrade
{
    class ВидиЦін_ШвидкийВибір : VBox
    {
        ...
        public ВидиЦін_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Види цін") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    ВидиЦін_Елемент page = new ВидиЦін_Елемент { IsNew = true };
