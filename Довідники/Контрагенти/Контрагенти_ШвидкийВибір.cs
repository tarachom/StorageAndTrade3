...
namespace StorageAndTrade
{
    class Контрагенти_ШвидкийВибір : VBox
    {
        ...
        public Контрагенти_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Контрагенти") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    Контрагенти_Елемент page = new Контрагенти_Елемент { IsNew = true };
