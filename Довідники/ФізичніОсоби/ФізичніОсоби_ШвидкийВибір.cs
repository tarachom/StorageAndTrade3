...
{
    class ФізичніОсоби_ШвидкийВибір : VBox
    {
        ...
        public ФізичніОсоби_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton($" {ФізичніОсоби_Const.FULLNAME}") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
                linkPage.Clicked += (object? sender, EventArgs args) =>
                {
                    ...
                    Program.GeneralForm?.CreateNotebookPage($"Вибір - {ФізичніОсоби_Const.FULLNAME}", () => { return page; }, true);
            ...
            //Новий
            {
                ...
                linkNew.Clicked += (object? sender, EventArgs args) =>
                {
                    ...
                    Program.GeneralForm?.CreateNotebookPage($"{ФізичніОсоби_Const.FULLNAME} *", () => { return page; }, true);
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ФізичніОсоби_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.ФізичніОсоби_ЗаписиШвидкийВибір.Where.Clear();

            ТабличніСписки.ФізичніОсоби_ЗаписиШвидкийВибір.LoadRecords();
        ...
        void LoadRecords_OnSearch(string searchText)
        {
            ...
            //Назва
            ТабличніСписки.ФізичніОсоби_ЗаписиШвидкийВибір.Where.Add(
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new ФізичніОсоби_Pointer(unigueID);
            }
        }
