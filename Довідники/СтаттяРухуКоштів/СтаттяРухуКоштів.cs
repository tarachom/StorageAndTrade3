...
{
    class СтаттяРухуКоштів : VBox
    {
        public СтаттяРухуКоштів_Pointer? SelectPointerItem { get; set; }
        ...
        public СтаттяРухуКоштів(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.СтаттяРухуКоштів_Записи.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.СтаттяРухуКоштів_Записи.LoadRecords();
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                SelectPointerItem = new StorageAndTrade_1_0.Довідники.СтаттяРухуКоштів_Pointer(unigueID);
            }
        }
