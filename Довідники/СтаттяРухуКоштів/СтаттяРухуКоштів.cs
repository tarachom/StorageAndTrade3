...
namespace StorageAndTrade
{
    public class СтаттяРухуКоштів : ДовідникЖурнал
    {
        ...
        {
            await СтаттяРухуКоштів_Функції.OpenPageElement(IsNew, uniqueID, CallBack_LoadRecords, null);
        }
        ...
        {
            return await СтаттяРухуКоштів_Функції.Copy(uniqueID);
        }

        protected override async ValueTask VersionsHistory(UniqueID uniqueID)
        {
            await СпільніФорми_ІсторіяЗміниДаних_Список.Сформувати(new СтаттяРухуКоштів_Pointer(uniqueID).GetBasis());
        }
