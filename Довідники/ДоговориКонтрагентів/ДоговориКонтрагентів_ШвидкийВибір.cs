...
namespace StorageAndTrade
{
    class ДоговориКонтрагентів_ШвидкийВибір : VBox
    {
        ...
        public ДоговориКонтрагентів_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ДоговориКонтрагентів_ЗаписиШвидкийВибір.Store);
