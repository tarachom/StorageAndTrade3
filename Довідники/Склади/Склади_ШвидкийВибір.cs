...
namespace StorageAndTrade
{
    class Склади_ШвидкийВибір : ДовідникШвидкийВибір
    {
        public Склади_ШвидкийВибір() : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton($" {Склади_Const.FULLNAME}") { Halign = Align.Start, Image = new Image(InterfaceGtk.Іконки.ДляКнопок.Doc), AlwaysShowImage = true };
        ...
        public override async ValueTask LoadRecords()
        {
            ...
            await ТабличніСписки.Склади_ЗаписиШвидкийВибір.LoadRecords(TreeViewGrid);
