...
namespace StorageAndTrade
{
    class Склади_Папки_ШвидкийВибір : ДовідникШвидкийВибір
    {
        ...
        protected override async ValueTask LoadRecords()
        {
            ...
            await ТабличніСписки.Склади_Папки_ЗаписиШвидкийВибір.LoadRecords(TreeViewGrid, OpenFolder);
        }
        ...
        protected override async ValueTask OpenPageList(UnigueID? unigueID = null)
        {
            ...
            NotebookFunction.CreateNotebookPage(Program.GeneralNotebook, $"Вибір - {Склади_Папки_Const.FULLNAME}", () => page);
