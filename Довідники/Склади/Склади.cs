...
namespace StorageAndTrade
{
    public class Склади : ДовідникЖурнал
    {
        ...
        public Склади() : base()
        {
            ...
            //Дерево папок
            ДеревоПапок = new Склади_Папки() { WidthRequest = 500, CallBack_RowActivated = LoadRecords_TreeCallBack, LiteMode = true };
        ...
        {
            NotebookFunction.AddChangeFunc(Program.GeneralNotebook, Name, LoadRecords, Склади_Const.POINTER);
            await LoadRecords();
        }
