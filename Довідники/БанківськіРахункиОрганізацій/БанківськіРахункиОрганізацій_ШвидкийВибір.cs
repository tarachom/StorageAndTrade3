...
{
    class БанківськіРахункиОрганізацій_ШвидкийВибір : VBox
    {
        ...
        public БанківськіРахункиОрганізацій_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Банківські рахунки організацій") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    БанківськіРахункиОрганізацій_Елемент page = new БанківськіРахункиОрганізацій_Елемент { IsNew = true };
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.БанківськіРахункиОрганізацій_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.БанківськіРахункиОрганізацій_ЗаписиШвидкийВибір.LoadRecords();
