...
{
    class ТипорозміриКомірок_ШвидкийВибір : VBox
    {
        ...
        public ТипорозміриКомірок_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Типорозміри комірок") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.ТипорозміриКомірок_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.ТипорозміриКомірок_ЗаписиШвидкийВибір.Where.Clear();

            ТабличніСписки.ТипорозміриКомірок_ЗаписиШвидкийВибір.LoadRecords();
        ...
        void LoadRecords_OnSearch(string searchText)
        {
            ...
            //Назва
            ТабличніСписки.ТипорозміриКомірок_ЗаписиШвидкийВибір.Where.Add(
