...
namespace StorageAndTrade
{
    class ПакуванняОдиниціВиміру : VBox
    {
        ...
        public ПакуванняОдиниціВиміру(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
                ...
                if (Message.Request(Program.GeneralForm, "Копіювати?") == ResponseType.Yes)
                {
                    ...
                    foreach (TreePath itemPath in selectionRows)
                    {
                        ...
                        if (ПакуванняОдиниціВиміру_Objest.Read(new UnigueID(uid)))
                        {
                            ...
                            ПакуванняОдиниціВиміру_Objest_Новий.Код = (++НумераціяДовідників.ПакуванняОдиниціВиміру_Const).ToString("D6");
