...
namespace StorageAndTrade
{
    ...
    {
        public ПакуванняОдиниціВиміру_ШвидкийВибір() 
        {
        ...
        protected override async ValueTask OpenPageList(UnigueID? unigueID = null)
        {
            ...
            NotebookFunction.CreateNotebookPage(Program.GeneralNotebook, $"Вибір - {ПакуванняОдиниціВиміру_Const.FULLNAME}", () => page);
