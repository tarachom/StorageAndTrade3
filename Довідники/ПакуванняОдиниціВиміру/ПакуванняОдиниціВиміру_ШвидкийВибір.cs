...
namespace StorageAndTrade
{
    class ПакуванняОдиниціВиміру_ШвидкийВибір : ДовідникШвидкийВибір
    {
        public ПакуванняОдиниціВиміру_ШвидкийВибір() : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton($" {ПакуванняОдиниціВиміру_Const.FULLNAME}") { Halign = Align.Start, Image = new Image(InterfaceGtk.Іконки.ДляКнопок.Doc), AlwaysShowImage = true };
                linkPage.Clicked += async (object? sender, EventArgs args) =>
                {
                    ...
                    NotebookFunction.CreateNotebookPage(Program.GeneralNotebook, $"Вибір - {ПакуванняОдиниціВиміру_Const.FULLNAME}", () => { return page; });
        ...
        {
            ТабличніСписки.ПакуванняОдиниціВиміру_ЗаписиШвидкийВибір.SelectPointerItem = null;
