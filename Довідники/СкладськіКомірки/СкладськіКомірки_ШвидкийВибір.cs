...
namespace StorageAndTrade
{
    class СкладськіКомірки_ШвидкийВибір : VBox
    {
        ...
        public СкладськіКомірки_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Складські комірки") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.СкладськіКомірки_ЗаписиШвидкийВибір.Store);
