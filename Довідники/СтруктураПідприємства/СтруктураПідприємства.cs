    ...
    public class СтруктураПідприємства : ДовідникЖурнал
    {
        ...
        protected override async ValueTask<(string Name, Func<Widget>? FuncWidget, System.Action? SetValue)> OpenPageElement(bool IsNew, UnigueID? unigueID = null)
        {
            ...
            if (!IsNew && unigueID != null)
                if (!await page.СтруктураПідприємства_Objest.Read(unigueID))
                {
                    Message.Error(Program.GeneralForm, "Не вдалось прочитати!");
                    return ("", null, null);
                }

            return (IsNew ? СтруктураПідприємства_Const.FULLNAME : page.СтруктураПідприємства_Objest.Назва, () => page, page.SetValue);
        }
