...
{
    public abstract class ДовідникШвидкийВибір : Box
    {
        /// <summary>
        /// Вспливаюче вікно
        /// </summary>
        ...
        public ДовідникШвидкийВибір(bool visibleSearch = true, int width = 600, int height = 300) : base(Orientation.Vertical, 0)
        {
            BorderWidth = 0;
