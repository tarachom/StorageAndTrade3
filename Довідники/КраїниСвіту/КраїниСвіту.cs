...
{
    class КраїниСвіту : VBox
    {
        public КраїниСвіту_Pointer? SelectPointerItem { get; set; }
        ...
        public КраїниСвіту() : base()
        {
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.КраїниСвіту_Записи.Store);
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                SelectPointerItem = new StorageAndTrade_1_0.Довідники.КраїниСвіту_Pointer(unigueID);
            }
        }
                ...
                if (Message.Request(Program.GeneralForm, "Копіювати?") == ResponseType.Yes)
                {
                    ...
                    foreach (TreePath itemPath in selectionRows)
                    {
                        ...
                        if (КраїниСвіту_Objest.Read(new UnigueID(uid)))
                        {
                            ...
                            КраїниСвіту_Objest_Новий.Save();

                            SelectPointerItem = КраїниСвіту_Objest_Новий.GetDirectoryPointer();
                        }
                        else
                            Message.Error(Program.GeneralForm, "Не вдалось прочитати!");
                    }
