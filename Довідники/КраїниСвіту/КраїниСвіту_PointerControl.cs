...
namespace StorageAndTrade
{
    class КраїниСвіту_PointerControl : PointerControl
    {
        ...
        protected override void OpenSelect(object? sender, EventArgs args)
        {
            ...
            КраїниСвіту_ШвидкийВибір page = new КраїниСвіту_ШвидкийВибір() { PopoverParent = PopoverSmallSelect, DirectoryPointerItem = Pointer };

            page.DirectoryPointerItem = Pointer;
            page.CallBack_OnSelectPointer = (КраїниСвіту_Pointer selectPointer) =>
            {
