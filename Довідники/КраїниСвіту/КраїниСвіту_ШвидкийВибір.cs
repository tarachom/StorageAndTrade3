...
{
    class КраїниСвіту_ШвидкийВибір : VBox
    {
        public Popover? PopoverParent { get; set; }
        public КраїниСвіту_Pointer? DirectoryPointerItem { get; set; }
        public System.Action<КраїниСвіту_Pointer>? CallBack_OnSelectPointer { get; set; }

        TreeView TreeViewGrid;
        SearchControl2 ПошукПовнотекстовий = new SearchControl2();

        public КраїниСвіту_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton($" {КраїниСвіту_Const.FULLNAME}") { Halign = Align.Start, Image = new Image(AppContext.BaseDirectory + "images/doc.png"), AlwaysShowImage = true };
                linkPage.Clicked += (object? sender, EventArgs args) =>
                {
                    ...
                    Program.GeneralForm?.CreateNotebookPage($"Вибір - {КраїниСвіту_Const.FULLNAME}", () => { return page; }, true);
            ...
            //Новий
            {
                ...
                {
                    КраїниСвіту_Елемент page = new КраїниСвіту_Елемент { IsNew = true, CallBack_OnSelectPointer = CallBack_OnSelectPointer };

                    Program.GeneralForm?.CreateNotebookPage($"{КраїниСвіту_Const.FULLNAME} *", () => { return page; }, true);
            ...
            //Очистка
            {
                ...
                linkClear.Clicked += (object? sender, EventArgs args) =>
                {
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new КраїниСвіту_Pointer());
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.КраїниСвіту_ЗаписиШвидкийВибір.Store);
        ...
        public void LoadRecords()
        {
            ...
            ТабличніСписки.КраїниСвіту_ЗаписиШвидкийВибір.Where.Clear();

            ТабличніСписки.КраїниСвіту_ЗаписиШвидкийВибір.LoadRecords();
        ...
        void LoadRecords_OnSearch(string searchText)
        {
            ...
            //Код
            ТабличніСписки.КраїниСвіту_ЗаписиШвидкийВибір.Where.Add(
        ...
        void OnRowActivated(object sender, RowActivatedArgs args)
        {
            if (TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                DirectoryPointerItem = new КраїниСвіту_Pointer(unigueID);
            }
        }
        ...
        void OnButtonPressEvent(object? sender, ButtonPressEventArgs args)
        {
            if (args.Event.Type == Gdk.EventType.DoubleButtonPress && TreeViewGrid.Selection.CountSelectedRows() != 0)
            {
                ...
                if (TreeViewGrid.Model.GetIter(out iter, TreeViewGrid.Selection.GetSelectedRows()[0]))
                {
                    ...
                    if (CallBack_OnSelectPointer != null)
                        CallBack_OnSelectPointer.Invoke(new КраїниСвіту_Pointer(new UnigueID(uid)));
