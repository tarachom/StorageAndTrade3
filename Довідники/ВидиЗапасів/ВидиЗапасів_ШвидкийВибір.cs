...
namespace StorageAndTrade
{
    class ВидиЗапасів_ШвидкийВибір : ДовідникШвидкийВибір
    {
        public ВидиЗапасів_ШвидкийВибір() : base()
        {
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton($" {ВидиЗапасів_Const.FULLNAME}") { Halign = Align.Start, Image = new Image(InterfaceGtk.Іконки.ДляКнопок.Doc), AlwaysShowImage = true };
                linkPage.Clicked += async (object? sender, EventArgs args) =>
                {
                    ...
                    NotebookFunction.CreateNotebookPage(Program.GeneralNotebook,$"Вибір - {ВидиЗапасів_Const.FULLNAME}", () => { return page; });
            ...
            //Новий
            {
                ...
                linkNew.Clicked += (object? sender, EventArgs args) =>
                {
                    ...
                    NotebookFunction.CreateNotebookPage(Program.GeneralNotebook,$"{ВидиЗапасів_Const.FULLNAME} *", () => { return page; });
