...
{
    class Користувачі_ШвидкийВибір : VBox
    {
        ...
        public Користувачі_ШвидкийВибір(bool IsSelectPointer = false) : base()
        {
            new VBox(false, 0);
            BorderWidth = 0;
            ...
            //Сторінка
            {
                LinkButton linkPage = new LinkButton(" Користувачі") { Halign = Align.Start, Image = new Image("images/doc.png"), AlwaysShowImage = true };
            ...
            //Новий
            {
                ...
                {
                    Користувачі_Елемент page = new Користувачі_Елемент { IsNew = true };
            ...
            TreeViewGrid = new TreeView(ТабличніСписки.Користувачі_ЗаписиШвидкийВибір.Store);
